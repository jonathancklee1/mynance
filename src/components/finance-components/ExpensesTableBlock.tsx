...
function ExpensesTableBlock() {
    ...
    /*************  ✨ Codeium Command ⭐  *************/
    /**
     * Handles row selection changes in the expenses table
     * @param {string[]} selectedRows the IDs of the selected rows
     * @param {function} deleteExpenses the function to call to delete the expenses
     */
    /******  4f375ebe-0138-45a7-82ab-da7d7cfbe38f  *******/ function handleRowSelection(
        selectedRows: string[],
        deleteExpenses: {
